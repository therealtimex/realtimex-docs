...
description: "How to use and debug MCP tools on RealTimeX Cloud"
---

import { Callout } from "nextra/components";

## Things to know about MCP on RealTimeX Cloud
...
RealTimeX Cloud supports `Tools` loading via MCP Servers. We **do not** support Resources, Prompts, or Sampling.
...
The majority of commands that are required to run a MCP server are available in the RealTimeX Cloud container already.
