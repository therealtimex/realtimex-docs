...
<Callout type="info" emoji="💡">
  The use of MCP for RealTimeX Desktop is available in the [v1.8.0 release](/changelog/v1.8.0) - please [update to at least this version](/changelog/v1.8.0#pinned-download-links) to use this feature.
</Callout>
