...
Each API endpoint requires specific permissions to be granted by the user. Permissions are requested on first app launch.
...
{
  "success": false,
  "error": "Permission denied: api.agents. Grant this permission in app settings.",
  "permission_required": "api.agents"
}
```

<Callout type="warning">
Users can revoke and re-grant permissions at any time via the Local Apps settings menu.
</Callout>
