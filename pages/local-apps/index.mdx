...
RealTimeX uses a **manifest-based permission system** to ensure security and transparency. Your Local App declares the permissions it needs in the SDK constructor, and RealTimeX handles the rest.
