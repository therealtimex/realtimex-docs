...
RealTimeX Desktop is a "**single-player**" application you can install on any Mac, Windows, or Linux operating system and get local LLMs, RAG, and Agents with little to zero configuration and full privacy.

## Docker vs Desktop Version

RealTimeX offers two main ways to use RealTimeX. There are some distinct differences in functionality between each offering. Both are open source.
...
<Callout type="info" emoji="️💡">
  **Tip:** RealTimeX Desktop is the easiest way to use RealTimeX.
</Callout>
...
<Card title="Local Docker Install" href="/installation-docker/local-docker">
  <Image
    ...
    width={1920}
    quality={100}
    alt="RealTimeX Local Docker Install"
  />
</Card>
...
>
  ...
  <Card title="Cloud Docker Install" href="/installation-docker/cloud-docker"> 
    <Image
      ...
      width={1920} 
      quality={100}
      alt="RealTimeX Cloud Docker Install"
    />
  </Card>  
</Cards>
