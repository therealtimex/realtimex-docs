...
- [x] The RealTimeX Marketplace (sharing plugins, prompts, workspaces, etc.)
- [x] Private RealTimeX Hub (sharing workspaces, prompts, plugins, etc. but private)
...
- [x] Simplified Token Tracking and monitoring sub-service (simple SDK that will be included in RealTimeX Desktop & Docker)
