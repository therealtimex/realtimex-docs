...
description: "Learn how to access and use the flow builder in RealTimeX"
---
...
Let's walk through how to access and use the flow builder in RealTimeX.
...
<Callout type="info" emoji="💡">
  Available blocks will vary depending on your RealTimeX version. Check the
