...
For the system-wide settings that decide how document text is segmented before vectorization, see [Text Splitting & Chunking](/text-splitting-chunking).
...
- Treat chunk-length changes carefully, because they can alter how documents are segmented before embedding. Review [Text Splitting & Chunking](/text-splitting-chunking) when you need to tune that behavior directly.
