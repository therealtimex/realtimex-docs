...
<Image
  ...
  width={1920}
  quality={100}
  alt="RealTimeX Security and Access"
/>
...
RealTimeX supports two types of use cases: **single-user** and **multi-user** mode.
...
When using RealTimeX in "single user mode," you can password protect the instance by toggling on the "Password Protect Instance" option. This will display an input where you can enter the password to protect the instance.
...
The preferred method of use for RealTimeX is **multi-user mode**. In this mode, you can set per-user role-based access permissions.
