---
title: "Chat Modes"
description: "Understanding the difference between Query and Chat modes in RealTimeX"
---

import { Callout } from "nextra/components";


# Chat Modes in RealTimeX

RealTimeX offers two ways to chat with your documents: Query mode and Chat mode. Let's understand what each does and how to get the best results.
