...
The Event Logs page in RealTimeX allows users to view and monitor various events that occur within the application.
...
Useful for monitoring your RealTimeX instance.
