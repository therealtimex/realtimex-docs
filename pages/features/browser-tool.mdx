...
description: "Have your LLM access and scrape authenticated content with RealTimeX's Authenticated Scraping tool"
---
...
<Callout type="info" emoji="🖥️">
  **Desktop Only Feature (v1.0.4+)**<br/>
  The Authenticated Scraping tool is exclusively available in the RealTimeX Desktop application!
</Callout>
...
<Callout type="warning" emoji="⚠️">
  **Security Note**
  All credentials and session data are stored locally on your machine. RealTimeX never transmits or stores your login information outside of your local machine.
</Callout>
...
3. RealTimeX can now access authenticated content from these services when scraping or via agentic workflow execution.
