...
3. [Plugins](/plugins)
4. [Credentials](/credentials), [Agent Authentication](/agent-authentication), or behavior config such as [System Prompts](/system-prompts) and [Personality](/personality)
