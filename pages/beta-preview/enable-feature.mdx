...
description: "Learn how to enable feature previews of RealTimeX"
---
...
While we take great care to craft features carefully we also want to proactively offer non-standard features to users of RealTimeX when in development or when we are looking for feedback.
...
- Partial or full data loss of RealTimeX's local database, source files, stored documents, or datastores
...
- Unhandled bugs, exceptions, and crashes of RealTimeX

# How to enable feature previews

<Callout>
  If you follow this procedure and nothing happens then this means that there
  are no active previews available for your version of RealTimeX.
</Callout>

To enable feature previews in RealTimeX in _any_ form (Docker, Desktop, Hosted) open the settings page by clicking on the "wrench" icon on the left sidebar.
