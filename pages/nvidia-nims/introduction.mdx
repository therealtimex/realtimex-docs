...
<Callout type="warning">
  NVIDIA NIM is currently in **beta** and is only available on Windows 11 on **RealTimeX Desktop v.1.0.4** and above.

  You can download the latest version of RealTimeX Desktop (v.1.0.4+) [here](https://realtimex.ai/).
</Callout>
