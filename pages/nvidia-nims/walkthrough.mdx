---
title: "Walkthrough"
description: "Learn how to use NVIDIA NIM in RealTimeX."
---
...
The use of NVIDIA NIM in RealTimeX is very simple and straightforward - all of the complexity is hidden from you by the RealTimeX Desktop client or the NVIDIA NIM Installer.


## Select the NVIDIA NIM LLM Provider

In RealTimeX Desktop, select the `NVIDIA NIM` LLM provider from the dropdown menu - this will show your the default NIM connector.
...
The official NVIDIA NIM installer is a pre-built binary that runs in the RealTimeX Desktop client built by NVIDIA. If your system or GPU is not compatible with running a NIM, you will see an error message during this step and will be unable to run a NIM on RealTimeX or your system in general.
...
After closing the completed NIM installer, you will see the blue button change to "Swap to Managed Mode". Clicking on this button will allow RealTimeX to manage your NIM models for you via a simple UI.
...
This is the recommended mode of operation for RealTimeX as it will allow you to easily update your NIM models and manage your NIM instances. Once you have swapped to managed mode, you will see the NIM manager UI with no models.
...
This means that your NIM is ready to use! You can now start using it in RealTimeX.

## Selecting your NIM in RealTimeX

To select your NIM in RealTimeX, simply click on the model card for the NIM you want to use and click "Save changes" in the top right.
...
You can now use this model in RealTimeX as you would any other model or provider.
...
Closing RealTimeX currently does not stop the NIM - so you will need to manually stop the NIM by clicking on the "Stop NIM" button in the NIM manager UI.
