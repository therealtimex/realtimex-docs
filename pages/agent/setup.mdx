...
description: "This guide explain how to setup AI Agents on RealTimeX"
---
...
<Image
  src="/images/RealTimeX-setup/agent-configuration/configuration-menu.png"
  height={1080}
  width={1920}
  quality={100}
  alt="RealTimeX Agent Configuration Menu"
/>
...
<Image
  src="/images/RealTimeX-setup/agent-configuration/llm.png"
  height={1080}
  width={1920}
  quality={100}
  alt="RealTimeX Agent LLM"
/>

After updating the workspace agent settings, click the "Configure Agent Skills" button.

<Image
  src="/images/RealTimeX-setup/agent-configuration/configure-agent-skills-button.png"
  height={1080}
  width={1920}
  quality={100}
  alt="RealTimeX Agent LLM"
...
<Callout type="info" emoji="️ℹ️">
  **Note**
    ...
    RealTimeX supports a lot of LLM providers for use with `@agent`s and you can see all the supported LLMs from [here](https://docs.realtimex.ai/features/language-models#supported-language-model-providers)
...
<Image
  src="/images/RealTimeX-setup/agent-configuration/tools.png"
  height={1080}
  width={1920}
  quality={100}
  alt="RealTimeX Agent Skills"
/>
...
<Image
  src="/images/RealTimeX-setup/agent-configuration/search.png"
  height={1080}
  width={1920}
  quality={100}
  alt="RealTimeX Agent Web Browsing"
/>

With Google Search Engine you can perform up to 100 search for free everyday.

**That's it! You can now use RealTimeX's Agents!**
