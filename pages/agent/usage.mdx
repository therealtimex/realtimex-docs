...
description: "How to use AI Agents on RealTimeX"
---
...
<Image
  ...
  width={1920}
  quality={100}
  alt="RealTimeX AI Agents Trigger"
/>
...
You can use RAG search by asking the agent something like `@agent can you check what you already know about RealTimeX?`
...
<Image
  ...
  width={1920}
  quality={100}
  alt="RealTimeX AI Agents RAG Search"
/>
...
<Image
  ...
  width={1920}
  quality={100}
  alt="RealTimeX AI Agents Web Browsing"
/>
...
Example: `@agent can you scrape the website realtimex.ai and give me a summary of features RealTimeX have?`
...
<Image
  ...
  width={1920}
  quality={100}
  alt="RealTimeX AI Agents Web Scraping"
/>
...
<Image
  ...
  width={1920}
  quality={100}
  alt="RealTimeX AI Agents Save Files"
/>

<Callout type="info" emoji="️💡">
  **Note**

    RealTimeX will show you an popup to choose the file location and file name to save the file.
...
<Image
  ...
  width={1920}
  quality={100}
  alt="RealTimeX AI Agents List Documents"
/>
...
Example: `@agent can you summarize the content on https://docs.realtimex.ai/features/chat-logs`
...
<Image
  ...
  width={1920}
  quality={100}
  alt="RealTimeX AI Agents Summarize Documents"
/>
...
<Image
  ...
  width={1920}
  quality={100}
  alt="RealTimeX AI Agents Chart Generation"
/>
...
<Image
  ...
  width={1920}
  quality={100}
  alt="RealTimeX AI Agents SQL Agent skill"
/>
...
This is because of the LLM you are using, not all LLMs are great of even useable for `tool-calling`. With RealTimeX we make every model possible to be used as an agent, but the strength of your model to comprehend the instruction and examples of tool calling is still reliant on the model itself. Smaller models with 4-Bit Quantization won't respond properly as an agent most times, but the very same model at 8Bit Quantization will give better response as an Agent -- same LLM but different quantization. If your agent is not responding properly then try using a higher quantization model or a larger model altoghether.
