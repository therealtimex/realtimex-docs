...
All OpenAI transcription models are currently available for use with RealTimeX.

<Image
  src="/images/RealTimeX-setup/transcription-model-configuration/cloud/openai/openai-transcription.png"
  height={1080}
  width={1920}
  quality={100}
  alt="OpenAI Transcription Model"
