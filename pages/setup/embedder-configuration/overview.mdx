...
<Image
  src="/images/RealTimeX-setup/embedder-configuration/header-image.png"
  height={1080}
  width={1920}
  quality={100}
...
You can modify your embedding provider and model at any time in RealTimeX. However doing so can result in broken queries and needing to re-embed uploaded and stored documents.
...
<Cards>
  <Card title="Built-in (default)" href="local/built-in"> 
    <Image
      src="/images/RealTimeX-setup/embedder-configuration/local/built-in/header-image.png" 
      height={1080} 
      width={1920} 
      quality={100}
...
<Card title="Ollama" href="local/ollama">
  <Image
    src="/images/RealTimeX-setup/embedder-configuration/local/ollama/header-image.png"
    height={1080}
    width={1920}
    quality={100}
    alt="Ollama"
...
<Card title="LM Studio" href="local/lmstudio">
  <Image
    src="/images/RealTimeX-setup/embedder-configuration/local/lmstudio/header-image.png"
    height={1080}
    width={1920}
    quality={100}
    alt="LM Studio"
  ...
  <Card title="Local AI" href="local/localai"> 
    <Image
      src="/images/RealTimeX-setup/embedder-configuration/local/localai/header-image.png" 
      height={1080} 
      width={1920} 
      quality={100}
      alt="Local AI"
...
<Cards>
  <Card title="OpenAI" href="cloud/openai"> 
    <Image
      src="/images/RealTimeX-setup/embedder-configuration/cloud/openai/header-image.png" 
      height={1080} 
      width={1920} 
      quality={100}
      alt="OpenAI"
...
<Card title="Azure OpenAI" href="cloud/azure-openai">
  <Image
    src="/images/RealTimeX-setup/embedder-configuration/cloud/azure-openai/header-image.png"
    height={1080}
    width={1920}
    quality={100}
    alt="Azure OpenAI"
  ...
  <Card title="Cohere" href="cloud/cohere"> 
    <Image
      src="/images/RealTimeX-setup/embedder-configuration/cloud/cohere/header-image.png" 
      height={1080} 
      width={1920} 
      quality={100}
      alt="Cohere"
