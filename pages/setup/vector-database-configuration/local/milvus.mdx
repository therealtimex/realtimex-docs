...
<Image
  src="/images/RealTimeX-setup/vector-database-configuration/local/milvus/header-image.png"
  height={1080}
  width={1920}
  quality={100}
...
<Image
  src="/images/RealTimeX-setup/vector-database-configuration/local/milvus/milvus-vectordb.png"
  height={1080}
  width={1920}
  quality={100}
