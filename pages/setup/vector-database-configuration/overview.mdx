...
<Image
  src="/images/RealTimeX-setup/vector-database-configuration/header-image.png"
  height={1080}
  width={1920}
  quality={100}
  alt="RealTimeX Vector Databases"
/>
...
<Callout type="error" emoji="️‼️">
  **Caution!**
    ...
    You should prevent "hopping" between vector databases. RealTimeX will not automatically port over your already embedded information.

    You would need to delete and re-embed each document in every workspace to migrate to another vector database.

</Callout>

RealTimeX supports many vector databases providers out of the box.
