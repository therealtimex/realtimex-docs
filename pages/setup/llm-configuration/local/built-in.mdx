...
If you want to connect RealTimeX to an external local provider instead, use pages such as [Ollama](/setup/llm-configuration/local/ollama), `LM Studio`, or `llama.cpp`.
