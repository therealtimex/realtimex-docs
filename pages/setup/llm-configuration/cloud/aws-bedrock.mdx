...
<Image
  src="/images/RealTimeX-setup/llm-configuration/cloud/aws-bedrock/header-image.png"
  height={1080}
  width={1920}
  quality={100}
...
<br/>
<Image
  src="/images/RealTimeX-setup/llm-configuration/cloud/aws-bedrock/aws-bedrock-llm.png"
  height={1080}
  width={1920}
  quality={100}
...
<Callout type="info">
  **Heads up!** You can optionally use `session tokens` for your AWS account if
  ...
  supported for RealTimeX's AWS Bedrock integration. [Learn more about
...
<Callout type="error">
  ...
  applications, not just RealTimeX.
</Callout>
...
<Callout type="info" emoji="️💡">
 Please only use a `chat` capable model for LLM selection. Incompatible model types will not produce chats in RealTimeX.
...
Below are where you can find `model ids` that you can use in RealTimeX.

<Image
  src="/images/RealTimeX-setup/llm-configuration/cloud/aws-bedrock/model-ids.png"
  height={1080}
  width={1920}
  quality={100}
...
Now that you have set up and have AWS Bedrock ready for LLM chatting, you can input the credentials to RealTimeX.
