...
# Tutorial: Building a HackerNews Filter Agent

In this tutorial, we'll create an agent flow that scrapes HackerNews and uses an LLM to filter posts based on topics you're interested in.
...
Start by opening the **Agent Builder** and clicking "Create Flow".
...
4. Review the [debugging flows guide](./debugging-flows) for more help
