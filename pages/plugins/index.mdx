...
- workspace-provision templates or prebuilt workspaces
- editor-backed configuration helpers for more complex setup
...
- Understand skill-discovery behavior on [Find Skills](/plugins/find-skills)
- Understand note retrieval and wiki behavior on [Notes, Wiki & Memory Plugins](/plugins/note-and-knowledge-plugins)
- Configure business-operations channels on [RealtimeX BizOps](/plugins/realtimex-bizops)
...
- Understand skill-authoring workflows on [Skill Creator](/plugins/skill-creator)
- Understand plugin-authoring workflows on [RealtimeX Plugin Developer](/plugins/realtimex-plugin-developer)
- Understand terminal governance surfaces on [Terminal Governance](/plugins/terminal-governance) and [RealtimeX AI Gateway](/plugins/realtimex-aigateway)
- Configure public workspace, embed, and artifact URLs on [RealtimeX Public Exposure](/plugins/realtimex-public-exposure)
- Configure multi-agent role topology on [RealtimeX Loops](/plugins/realtimex-loops)
...
Workspace-provision plugins can also skip the normal enable or reload flow and instead focus on deployment actions that create or update workspaces from plugin-defined templates.
