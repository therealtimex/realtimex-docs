---
title: "502 Error on RealTimeX Hosted"
...
<Callout type="warning" emoji="️⚠️">
  **Notice**
  This page only applies to the Hosted Cloud version of RealTimeX and only applies to those using the built-in embedder model.
...
### I am getting a 502 on my hosted RealTimeX!
...
- Visit [Your RealTimeX Cloud Dashboard](https://my.realtimex.ai/dashboard) account.
...
<Image
  ...
  width={500}
  quality={100}
  alt="RealTimeX Subscription Item"
/>
...
<Image
  ...
  width={500}
  quality={100}
  alt="RealTimeX Subscription Dashboard"
/>
...
<Image
  ...
  width={500}
  quality={100}
  alt="RealTimeX Subscription Reboot"
/>
...
- [Switch to a cloud based embedder](/RealTimeX-setup/embedder-configuration/overview#cloud-model-providers)
