...
- [x] You are using the default RealTimeX embedder model
...
- Try embedding again.
- Unblock this origin: `https://cdn.realtimex.ai/support/models/`
- Try embedding again.
...
- [x] You are using the default RealTimeX vector database

### Why is this happening?

[LanceDB](https://lancedb.github.io/lancedb/) is a vector database that is used to store the embeddings. It is the default vector database for RealTimeX.
